...
**Câu 2:** Thiết bị ở trường: Kính hiển vi quang học (lĩnh vực Sinh học tế bào); Bộ đồ mổ (Sinh học cơ thể); Ống nghiệm, hóa chất (Sinh hóa học).
**Câu 3:** Kính HV quang học dùng ánh sáng, phóng đại 1500 lần, quan sát cấu trúc tế bào cơ bản. Kính HV điện tử dùng chùm electron, phóng đại 50 triệu lần, độ phân giải <1 Å, quan sát cấu trúc siêu hiển vi (virus, DNA).

### 2. Dừng lại và suy ngẫm (Trang 17)
**Câu 1:** Tiến trình nghiên cứu: (1) Quan sát thu thập dữ liệu $\rightarrow$ (2) Đặt câu hỏi $\rightarrow$ (3) Hình thành giả thuyết $\rightarrow$ (4) Thiết kế thí nghiệm kiểm chứng $\rightarrow$ (5) Phân tích số liệu $\rightarrow$ (6) Rút ra kết luận.
**Câu 2:** Tư duy khoa học:
- **Tư duy quy nạp (khi hình thành giả thuyết):** Từ nhiều quan sát lẻ tẻ đúc kết thành nguyên lý chung.
- **Tư duy diễn dịch (khi kiểm chứng):** Từ nguyên lý chung đưa ra dự đoán thực tế ("Nếu... thì...").
**Câu 3:** Điểm khác biệt lô đối chứng và lô thực nghiệm: Giống hệt nhau mọi điều kiện, chỉ khác ở **duy nhất 1 yếu tố (biến độc lập)** cần nghiên cứu. Ví dụ: Thử nghiệm phân bón, lô đối chứng không bón phân, lô thực nghiệm bón phân (nước, ánh sáng, giống cây như nhau).

### 3. Dừng lại và suy ngẫm (Trang 18)
**Câu 1:** Vai trò tin sinh học: Lưu trữ phân tích bản đồ gen người; xây dựng sơ đồ tiến hóa; ứng dụng AI phân tích hình ảnh chẩn đoán bệnh cực sớm và chính xác.
**Câu 2:** Ứng dụng trong học tập: Tìm kiếm dữ liệu internet; dùng phần mềm đồ họa 3D mô phỏng phân chia tế bào; lập sơ đồ tư duy hệ thống kiến thức.

### 4. Luyện tập và vận dụng (Trang 18)
**Câu 1:** Tin sinh học là ngành dùng máy tính, phần mềm, thuật toán để lưu trữ, phân loại và phân tích dữ liệu sinh học ở quy mô lớn.
**Câu 2:** Để quan sát tế bào thực vật dùng kính hiển vi quang học. Quan sát NST cần kĩ thuật làm tiêu bản tế bào (cố định, nhuộm màu đặc hiệu, dầm ép mẫu làm bung NST).
